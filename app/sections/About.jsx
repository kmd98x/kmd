...
import { createHeaderToAboutTransition } from "../animations/headerToAboutAnimation";
...
export default function About() {
    ...
    useLayoutEffect(() => {
        ...
        if (!section || !heroContent) return undefined;
        return createHeaderToAboutTransition(heroContent, section);
    }, []);

    useEffect(() => {
        if (titleRef.current) titleAnimation(titleRef.current);
        if (textContent.current) aboutTextAnimation(textContent.current);
    }, []);
    ...
    return (
        ...
        >
            <div className="max-md:-mt-32 rounded-2xl p-16 w-full flex items-center justify-center" ref={textContainer}>
