...
export default function About() {
    return (
        <section id="about" className="md:flex md:flex-row-reverse md:items-center md:py-32relative relative md:h-[100vh]">
            <img
                className="md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 -z-10"
            ...
            <div className="max-md:-mt-32 md container">
                ...
                <p className="text-[15px] md:max-w-[40ch]">
