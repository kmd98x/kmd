    ...
    return (
        <footer id="footer" className="container pb-12 flex items-center">
            <div className="w-full">
                <span className="inline-block w-full h-px bg-[#BB997E]/30 mb-5"></span>
                ...
                <div className="flex items-center flex-wrap mt-5 gap-12 justify-center">
                    <a href="mailto:kmd98x@hotmail.com" target="_blank" className="text-[#BB997E] flex flex-col items-center gap-1 mt-1">
                        <FontAwesomeIcon icon={faEnvelope} className="w-7" />
                        <h4 className="text-lg leading-none mt-2">Email</h4>
                        kmd98x@hotmail.com
                    </a>
                    
                    <a href="https://linkedin.com/in/kmd98" target="_blank" className="text-[#BB997E] flex flex-col items-center gap-1 mt-1">
                ...
                <div className="flex justify-center items-center gap-5 text-[#BB997E] mt-10">
